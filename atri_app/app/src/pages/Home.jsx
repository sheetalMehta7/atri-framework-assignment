...
const Flex1486Props = useStore((state)=>state["Home"]["Flex1486"]);
const Flex1486IoProps = useIoStore((state)=>state["Home"]["Flex1486"]);
...
<Flex className="p-Home Flex1486 bpt" {...Flex1486Props} {...Flex1486Cb} {...Flex1486IoProps}>
